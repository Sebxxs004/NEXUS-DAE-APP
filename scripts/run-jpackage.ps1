...
if (Test-Path .\target\dist\NEXUS-DAE) { Remove-Item -Recurse -Force .\target\dist\NEXUS-DAE }
...
& $jpackage --type app-image --input .\target\package --main-jar NEXUS-DAE.jar --main-class com.prisma.Launcher --name NEXUS-DAE --runtime-image jlink-runtime --resource-dir $resDir --app-version 1.0.0 --dest .\target\dist
